...
const Insumos = () => {
    ...
    return (
        <section className='bg-black'>
            ...
            <h1 className='text-white text-center font-microflf pt-[3.5em] pb-[1em] text-[40px]'>INSUMOS</h1>

            <h2 className='border-t border-white-400/10 text-white text-center font-microflf py-[1em] xl:pb-[0] text-[30px]'>LIQUIDO DE <span className='inline-block text-pale-red'>ESPUMA</span></h2>
                ...
                {articulos.map((articulo, index) => (
                    <div key={index} className="flex flex-col gap-y-2 mx-2 border px-2 md:px-0 py-4 rounded-md">
                        ...
                        <div className='flex flex-row justify-around items-center'>
                            <p className='text-white text-center font-montserrat text-sm md:text-[16px]'>{articulo.descripcion}</p>
            ...
            <h2 className='border-t border-white-400/10 text-white text-center font-microflf py-[1em] xl:pb-[0] text-[30px]'>ADITIVOS DE <span className='inline-block text-pale-red'>COLOR</span> </h2>
            ...
            <h2 className='border-t border-white-400/10 text-white text-center font-microflf py-[1em] xl:pb-[0] text-[30px]'>ACCESORIOS <span className='inline-block text-pale-red'>/ REFACCIONES</span> </h2>
