    ...
    return (
        <section className='bg-black'>
            <div className="w-full flex xl:flex-row flex-col justify-center min-h-screen max-container gap-10">
                <div className="w-full xl:w-2/5 relative flex flex-col justify-center items-start pr-2 pl-8 sm:pl-16 pt-28 mt-8 lg:mt-0">
                ...
                <div className="relative flex-1 flex justify-center items-center border-2 border-white/50 rounded-2xl mx-10 wide:mx-0 xl:mt-[8rem] pt-10 pb-[10rem] sm:pb-[15rem] bg-black">
