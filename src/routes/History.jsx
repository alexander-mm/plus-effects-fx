        ...
        <section>
            <div className="w-full flex flex-col justify-center items-center min-h-screen xl:min-h-[91vh] max-container pb-8 sm:pb-14 xl:py-0">
                ...
                <div className='w-1/2 mt-20'>
                    <img src="https://www.masqueunefecto.com/wp-content/uploads/2024/01/portada-scaled.jpg" alt="" />
                </div>

                <div className='w-4/5 md:w-4/5 text-white text-lg font-century flex flex-col'>
                    ...
                    <div className='flex flex-col gap-y-20 lg:gap-y-0'>
                        ...
                        <div className='flex flex-col lg:flex-row justify-center items-center gap-y-4 lg:gap-y-0 md:gap-x-8'>
                            <p>
                            ...
                            <figure className='flex flex-col items-end'>
                                ...
                                <figcaption className='text-white font-bold text-sm text-center'>ESPUMA GUN X</figcaption>
                            </figure>

                        </div>
                        <div className='flex flex-col lg:flex-row-reverse justify-center items-center md:gap-x-8 gap-y-4 lg:gap-y-0'>
                            <p>
                            ...
                            <figure className='flex flex-col items-end'>
                                ...
                                <figcaption className='text-white font-bold text-sm text-center'>ESPUMA PRO (MHB-400 PRO MKI)</figcaption>
                            </figure>
                        </div>
                        <div className='flex flex-col lg:flex-row justify-center items-center md:gap-x-8 gap-y-4 lg:gap-y-0'>
                            <p>
                            ...
                            <figure className='flex flex-col items-end'>
                                ...
                                <figcaption className='text-white font-bold text-sm text-center'>ESPUMA SP (FCM-350 MKI)</figcaption>
                            </figure>
                        </div>
                        <div className='flex flex-col lg:flex-row-reverse justify-center items-center md:gap-x-8 gap-y-4 lg:gap-y-0'>
                            <p>
                            ...
                            <figure className='flex flex-col items-end'>
                                ...
                                <figcaption className='text-white font-bold text-sm text-center'>ESPUMA SP (FCM-350 MKII)</figcaption>
                            </figure>
                            <figure className='flex flex-col items-end'>
                                ...
                                <figcaption className='text-white font-bold text-sm text-center'>ESPUMA PRO (MHB-400 PRO MKII)</figcaption>
                            </figure>
                        ...
                        <div className='flex flex-col lg:flex-row justify-center items-center md:gap-x-8 gap-y-4 lg:gap-y-0'>
                            ...
                            <figure className='flex flex-col items-end'>
                                ...
                                <figcaption className='text-white font-bold text-sm text-center'>ESPUMA ONE (FCM-350 MKIII)</figcaption>
                            </figure>
                        </div>
