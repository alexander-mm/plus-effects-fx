...
import { xpowder } from "../assets/shop-items";
...
const FluidContainer = () => {
    ...
    const [bigImg, setBigImg] = useState(xpowder)
    ...
    return (
        <section id='container' className='bg-black'>
            ...
            <div className="w-full flex flex-col justify-center gap-y-10 min-h-screen max-container py-4">
                <h1 className='text-white text-center font-century text-[40px]'>ESPUMA <span className="text-pale-red">XPOWDER</span></h1>

                <div className="flex flex-col justify-center items-center mb-12">

                    <div className="text-white text-center ">
                        <p className="font-century text-3xl">{t('xpowder')}</p>
                                ...
                                {supplies.map((image, index) => (
                                    <div key={index}>
                                        <ItemShowCard
                                            ...
                                            bigImg={bigImg}
                                            shouldRender={(bidon) => bidon.confirm === "powder"}
                                        />
                                    </div>
                                ))}
                            </div>
                        ...
                        <p className="font-century text-lg">{t('descrip-xpowder')}</p>
