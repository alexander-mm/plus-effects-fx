                ...
                <div className="flex flex-col justify-center items-center mb-12">
                    ...
                    <div className="text-white text-center">
                        ...
                        <div className="flex flex-col justify-center items-center">
                            ...
                            <p className="font-century text-lg leading-8 text-start">- Bomba de superficie 750W.<br />-Interruptor incorporado.<br />- Cable de conexión a toma corriente eléctrico.<br />- 4 Metros de manguera de 1 Pulgada con refuerzo en acero. <br />- Filtro textil incorporado.</p>
